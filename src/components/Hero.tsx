...
export const Hero = ({
  ...
  if (isTrendingLoading || !activeMovie) {
    return (
      <div className="relative h-[65dvh] min-h-[460px] lg:h-[88vh] lg:min-h-0 w-full overflow-hidden bg-[#050505] flex items-center justify-center">
  ...
  return (
    <div className="relative h-[65dvh] min-h-[460px] lg:h-[88vh] lg:min-h-0 w-full overflow-hidden bg-[#050505]">
